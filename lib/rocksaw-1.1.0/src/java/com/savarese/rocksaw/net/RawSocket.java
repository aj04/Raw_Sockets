...
public class RawSocket {
  ...
  private native static int __socket(int protocolFamily, int socket_type, int protocol);
   ...
   */
  public void open(int protocolFamily, int sock_type, int protocol)
    throws IllegalStateException, IOException
  {
    if(isOpen())
      throw new IllegalStateException();
    __socket = __socket(protocolFamily, sock_type, protocol);
